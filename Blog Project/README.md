...
- Create posts with cover images (multipart file upload)
- View all public posts
- View single post details
- Edit own posts (title, content, category, image)
- Delete own posts
- View user's own posts
- 10 blog categories (Technology, Health, Lifestyle, Education, Entertainment, Business, Travel, Food, Sports, Finance)
...
- Automatic image file naming with timestamp and random ID
- Public image serving via `/uploads` endpoint
...
```bash
PORT=4000
MONGODB_URI=mongodb://127.0.0.1:27017/MindStream
